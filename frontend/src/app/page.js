    ...
    <div className="bg-white">
            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Connect with your community to share excess food and help those in need. Reduce food waste and make a difference in someone's life today.
                </p>
                <div className="mt-10 flex items-center gap-x-6">
                  ...
                  >
                    Request Food <span aria-hidden="true">→</span>
                  </Link>
                </div>
              </div>
            </div>
      ...
      <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-green-600">Better Together</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Everything you need to share food with your community
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Our platform makes it easy to connect food donors with those in need, creating a more sustainable and caring community.
          </p>
        </div>
            ...
            {features.map((feature) => (
              <div key={feature.name} className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  ...
                  <p className="mt-6">
                    <Link href={feature.href} className="text-sm font-semibold leading-6 text-green-600">
...
const features = [
  {
    name: 'Food Donations',
    description: 'Share your excess food with those who need it. Easy to post and manage your donations.',
    href: '/food-donations',
    icon: (
  ...
  {
    name: 'Food Requests',
    description: 'Request food assistance from your community. Simple and dignified process.',
    href: '/food-requests',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-green-600">
  ...
  {
    name: 'Community Blog',
    description: 'Share stories, tips, and experiences about food sharing and community building.',
    href: '/blog',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-green-600">
